...
export const PRICES = {
  // Base territory pricing: $99/month
  BASE: process.env.STRIPE_PRICE_BASE_99 || process.env.STRIPE_PRICE_BASE_250!, // Fallback for backward compatibility
  // Adjacent pricing deprecated - kept for backward compatibility only
  ADJACENT: process.env.STRIPE_PRICE_ADJACENT_220!,
  // DMA pricing: $1,000/month
  DMA: process.env.STRIPE_PRICE_DMA_1000 || process.env.STRIPE_PRICE_DMA_3000 || process.env.STRIPE_PRICE_BASE_99 || process.env.STRIPE_PRICE_BASE_250!, // Fallback to base if DMA price not set
}
